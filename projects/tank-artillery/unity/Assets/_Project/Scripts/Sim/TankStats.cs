    ...
    public struct TankStats
    {
        ...
        static TankStats[] BuildTable()
        {
            ...
            t[1] = Row(TankKind.CrossBow, TankEra.Classic, "크로스보우", 940, 99f, 570,
                       1.05f, 1.00f, 0.85f, 4.5f, 4.5f, 330f, 340f, 15f, 80f, 1.04f,
                       "독화살", 0.90f, 0.80f, 0.30f, 0.50f);
            //   ⚠️ 직격 200→270→340 (2026-09-17, AI 이동 도입 후 재측정. 270 에서 30% 라 한 걸음 더). 승률 17~22% 로 최하위였는데
            //     **명중률은 75% 로 1위**였다 — 잘 쏘는데 지는 판이었다. 원인은 폭발 4.5m(최하위, 원작 31)이라
            //     빗맞으면 거의 0 인데 정타 보상이 작았던 것. 폭발을 키우면 원작 정체성이 무너지므로
            //     **정타 보상만** 올려 "가장 정확한 탱크가 가장 큰 한 방을 낸다"로 축을 세운다.
