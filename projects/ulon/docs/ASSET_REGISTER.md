...
| KayKit Adventurers 1.0 | 플레이어/동료/무기/파츠 | CC0 | GitHub Standard | 2026-08-31 | Knight.fbx, Mage.fbx, Rogue.fbx, sword_1handed.fbx, shield_round.fbx (Barbarian.fbx는 상반신 맨살이라 몹·동료 사용 금지 — `Editor/MobArt.cs` 자격 원장) / **2026-09-08 추가(오너 승인 2026-09-08)**: RogueHooded.fbx, staff.fbx, spellbook_closed.fbx, dagger.fbx, mug_full.fbx — 배포처에 `spellbook.fbx`·`mug.fbx`라는 이름은 없어 닫힌 책·찬 잔으로 받았다 | https://github.com/KayKit-Game-Assets/KayKit-Character-Pack-Adventures-1.0 |
