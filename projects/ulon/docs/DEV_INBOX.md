...
## 오너 2026-09-13 — 플레이 루프 우선

개발 순서 최우선: **전투 → 제작 → 채집 → 소셜**(동급 묶음, 그래픽보다 앞).
그록: 이 네 축의 룰·플레이 검증·2클라 동기화. Codex/GPT 그래픽·월드맵은 병행 가능하나 그록 다음 할 일을 밀지 않음.
근거 INBOX 긴급 (2026-09-13 10:24).

---


## 오너 2026-09-12 16:38 — 그래픽·UI는 GPT

GPT가 그래픽/UI 개선을 한다. 그록 자율 루프는 셰이더·머티리얼·지형/물 비주얼·HUD 외형·아이콘·페이퍼돌 그림·커서 스킨·VFX 폴리시를 새 작업으로 열지 않는다. 서버·저장·네트·2클라·관심영역·클라 빌드·룰은 그록.
