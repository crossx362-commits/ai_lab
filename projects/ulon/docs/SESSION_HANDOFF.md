...
8db38fed(원장 레코드 단위 검증 + AssertDataRecordSanity), 7109348d(왕관·무기 부착 반려 2건 + BossFit), c7fd68b4(정리 묶음), 06f64758(보스 1몹 1무기·그립 높이), 2c5929d5(지형 랩), 82599509(잡몹 드레싱·사냥터·QA 런타임 포즈).
...
1. **제작법(CraftRecipes) 외부화**(§12.2) — 다음 차례.
