...
namespace Ulon.Editor
{
    public static partial class SliceSelfCheck
    {
        ...
        /// </summary>
        // 실측(2026-09-06, 등록 CC0 소품으로 교체한 뒤): 채운 상태 던전 1·2·3 = 0.41 / 0.43 / 0.41,
        // 소품을 치운 결함 상태 = 0.65. 상한은 0.45 그대로 둔다 — 색칠 큐브 시절 0.29는 거대한 판 슬래브가
        // 화면을 덮은 값이라 기준이 될 수 없다(그 판이 바로 검수 반려 사유였다).
