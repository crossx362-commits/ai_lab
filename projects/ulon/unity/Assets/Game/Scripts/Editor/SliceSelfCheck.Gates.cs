...
namespace Ulon.Editor
{
    public static partial class SliceSelfCheck
    {
        ...
        static void RunGates()
        {
            ...
            Gate(AssertFieldFlat);           // 밭은 평평한 자리에 — 비탈밭은 「경작지」로 안 읽힌다
            Gate(AssertGravelTone);          // 자갈이 대낮 화면에서 모래와 한 톤으로 읽히지 않게
            ...
            Gate(AssertWorldMapBake);        // 월드맵이 지형·호수·마을을 구분하는가(INBOX 지도)
            Gate(AssertCoastRamp);           // 바다 해안이 백사장인가(물 **안쪽** 얕은 띠의 가로 폭)
            ...
            Gate(AssertContainerDnDNegativeControl);
            Gate(AssertContainerDnD);
            Gate(AssertContextMenuNegativeControl);
            Gate(AssertContextMenu);
            Gate(AssertTargetCursorNegativeControl);
            ...
            Gate(AssertInterest);
            Gate(AssertMoveAuthorityNegativeControl);
            ...
            Gate(AssertManaRegenNegativeControl);
            Gate(AssertManaRegen);
            Gate(AssertHpRegenNegativeControl);
            Gate(AssertHpRegen);
            Gate(AssertAttackSpeedNegativeControl);
            Gate(AssertAttackSpeed);
            Gate(AssertHitChanceNegativeControl);
            Gate(AssertHitChance);
            Gate(AssertParryChanceNegativeControl);
            Gate(AssertParryChance);
            Gate(AssertPhysicalArmorNegativeControl);
            Gate(AssertPhysicalArmor);
