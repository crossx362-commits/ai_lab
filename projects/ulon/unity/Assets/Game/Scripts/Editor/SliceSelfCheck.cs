    ...
    public static partial class SliceSelfCheck
    {
        ...
        public static void Run()
        {
            ...
            if (!MobCatalog.TryGet(MobCatalog.BoneWarden, out MobDefinition bossDefinition)
                ...
                || Math.Abs(bossDefinition.Height - 2.60f) > 0.0001f || !MobCatalog.IsBoss(MobCatalog.BoneWarden)
            ...
            if (!MobCatalog.TryGet(MobCatalog.ShadowCaptain, out MobDefinition boss2Definition)
                ...
                || Math.Abs(boss2Definition.Height - 2.70f) > 0.0001f || !MobCatalog.IsBoss(MobCatalog.ShadowCaptain)
            ...
            if (!MobCatalog.TryGet(MobCatalog.Hexarch, out MobDefinition boss3Definition)
                ...
                || Math.Abs(boss3Definition.Height - 2.80f) > 0.0001f || !MobCatalog.IsBoss(MobCatalog.Hexarch)
