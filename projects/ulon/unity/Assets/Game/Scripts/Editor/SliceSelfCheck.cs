...
namespace Ulon.Editor
{
    public static partial class SliceSelfCheck
    {
        ...
        public static void Run()
        {
            ...
            VisualSliceBuilder.EnsureCapDressing();   // 던전 뚜껑이 만들어진 뒤라야 그 위에 얹을 수 있다
