...
namespace Ulon.Editor
{
    ...
    public static partial class QaShots
    {
        ...
        public static void Run()
        {
            ...
            SliceSelfCheck.AssertOutdoorGrainNegatives();   // 위 둘의 NC를 한 판에 묶어 굽는다
            SliceSelfCheck.AssertWaterNotStamped();
            SliceSelfCheck.AssertWaterNotWoven();
            // 물가에 깊이 페이드·거품이 있는가 — 물 재작업 1단계가 세운 자(2026-09-11).
            SliceSelfCheck.AssertShoreFoam();
