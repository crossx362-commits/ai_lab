...
namespace Ulon.Editor
{
    public static partial class VisualSliceBuilder
    {
        ...
        /// </summary>
        /// <summary>
        /// 사냥터 잡몹의 자리 — **원장은 `Ulon.Shared.HuntRoster`로 옮겼다**(검수 랩 ④).
        /// 도포가 몹 자리를 모르면 얼룩과 몹이 어긋난다(「몹은 잔디에, 흙은 그 옆에」).
        /// 여기서는 그 원장을 그대로 읽는다 — 자리를 고치려면 Shared 쪽 하나만 고친다.
        /// </summary>
        public static (string Name, float X, float Z, float Yaw)[] HuntSpots => Ulon.Shared.HuntRoster.Spots;
