...
config:
  ...
  OUTPUT_DIR — 어디에 만들지 (비우면 ~/ai-team-projects/)
...
console.log("✦ AI Team 사이트 로드 완료");
''',
        "README.md": f'''# {name}

AI Team 코다리가 셋업한 정적 웹사이트.
...
def main():
    ...
    # 출력 위치
    if not out_dir:
        out_dir = os.path.expanduser("~/ai-team-projects")
