...
**발행일**: 2026-06-11 (2026-07-08 주식·코인 도메인 삭제 이후 현 로스터 기준 갱신)  
**대상**: AI 팀 전체 (예원·영숙 + 펫나 QA·개발팀)  
...
| 에이전트 | 우선순위 | 적용 분야 |
|---------|---------|----------|
| **예원 (CEO)** | 🔴 HIGH | petnna UI/UX 개선 디스패치 시 MasterClass 디자인 시스템 기준 적용 |
| 영숙 (비서) | ⚪ REFERENCE | - |

> ※ 과거 담당(티모·코다리 등)과 주식·코인 에이전트(2026-07-08 전면 삭제)는 로스터에서 제거됨. petnna 디자인 작업은 예원 디스패치로 수행.
