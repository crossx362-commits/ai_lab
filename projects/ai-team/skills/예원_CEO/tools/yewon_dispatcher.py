...
def dispatch_and_execute(ceo_message: str) -> str:
    ...
    try:
        ...
        _agent_keywords = {
            ...
            "시그널": ["시그널", "펄스", "시장 분석", "코인 동향", "주가 동향", "주식 동향", "코인", "주식", "crypto", "stock"],
            "티모": ["티모", "디자인 검토", "UI", "UX"],
        ...
        def _match(agent: str, names: list, msg_keywords: list = None) -> bool:
            ...
            if msg_keywords:
                ...
                all_known = ["ceo", "예원", "시그널", "펄스", "business", "케빈", "kevin", "로율", "legal", "코다리", "developer", "경수", "cyber", "영숙", "secretary", "티모", "timo", "데이브", "dave", "레오", "leo"]
        ...
        elif _match(agent, ["시그널", "펄스", "business", "research", "strategist"], ["시장 분석", "코인 동향", "주가 동향", "주식 동향", "시그널", "펄스"]):
            import subprocess
