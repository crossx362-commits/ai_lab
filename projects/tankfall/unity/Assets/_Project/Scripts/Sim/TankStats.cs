    ...
    public struct TankStats
    {
        ...
        static TankStats[] BuildTable()
        {
            ...
            t[0] = Row(TankKind.Catapult, TankEra.Classic, "캐터펄트", 950, 100f, 560,
                       0.95f, 1.15f, 1.10f, 6.6f, 8.0f, 300f, 90f, 0f, 90f, 0.91f,
            ...
            t[1] = Row(TankKind.CrossBow, TankEra.Classic, "크로스보우", 940, 99f, 570,
                       1.05f, 1.00f, 0.85f, 4.5f, 4.5f, 330f, 200f, 15f, 80f, 1.04f,
                       "독화살", 0.90f, 0.80f, 0.30f, 0.50f);
            //   원작: 1번 창(330/폭발31), 2번 독화살(100/폭발28 + 지속피해 — 미구현이라 일단 약한 탄)
            t[2] = Row(TankKind.Cannon, TankEra.Classic, "캐논", 920, 89f, 580,
                       1.00f, 1.00f, 1.00f, 11.4f, 9.0f, 140f, 60f, 25f, 45f, 0.87f,
            ...
            t[4] = Row(TankKind.Duke, TankEra.Early, "듀크탱크", 1000, 123f, 560,
                       1.00f, 0.95f, 1.00f, 8.0f, 6.5f, 240f, 110f, 0f, 40f, 1.09f,
                       "독구름", 0.78f, 0.60f, 0.62f, 0.50f);
            //   원작: 1번 240/폭발55, 2번 독구름 150/폭발43 바람에 휨 + 지속피해(미구현)
            t[5] = Row(TankKind.MineLander, TankEra.Early, "마인랜더", 1150, 120f, 560,   // 방어·공격 [추정]
                       0.95f, 1.00f, 1.05f, 6.0f, 8.5f, 200f, 80f, 5f, 40f, 1.00f,
            ...
            t[6] = Row(TankKind.Missile, TankEra.Modern, "미사일", 1100, 117f, 560,
                       1.12f, 1.00f, 1.15f, 6.6f, 7.5f, 300f, 70f, 20f, 45f, 1.04f,
            ...
            t[7] = Row(TankKind.MultiMissile, TankEra.Modern, "멀티미사일", 1050, 115f, 570,
                       1.10f, 1.00f, 1.20f, 5.8f, 8.0f, 175f, 40f, 25f, 50f, 1.00f,
            ...
            t[9] = Row(TankKind.Laser, TankEra.Future, "레이저탱크", 990, 90f, 540,   // 방어·이동 [추정]
                       1.15f, 0.90f, 0.55f, 4.0f, 4.0f, 200f, 220f, 5f, 36f, 1.04f,
            ...
            t[10] = Row(TankKind.IonAttacker, TankEra.Future, "이온어태커", 970, 91f, 550,
                        1.00f, 1.00f, 1.00f, 7.0f, 10.0f, 200f, 110f, 20f, 55f, 1.27f,
                        "위성탄", 1.38f, 1.30f, 1.35f, 0.80f);
            //   ⚠️ 굴착 10.0 은 실측값(명세 §2-9-5): 12.0 으로 두면 §2-5-1 나선이 자기 명중률부터 죽여 승률 25%(꼴찌),
            //      8→66% · 9.5→60% · 10→50% · 10.5→39% · 11→29%. 10 이어도 12종 중 최대 굴착이라 "지형 완전 파괴" 정체성은 남는다.
            ...
            t[12] = Row(TankKind.SecWind, TankEra.Future, "세크윈드", 985, 92f, 530,
                        1.00f, 1.05f, 1.00f, 9.5f, 6.5f, 220f, 110f, 0f, 40f, 1.45f,
