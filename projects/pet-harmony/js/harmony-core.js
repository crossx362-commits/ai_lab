// 조화도 명리 코어 — 갑자/오행/조화도/일진 순수 계산(DOM 금지). UMD-lite.
(function (root) {
    ...
    const REL_TEXT = {
        상생: (p, o) => `${p} 기운의 펫과 ${o} 기운의 집사 — 서로를 살려주는 상생 조화예요. 함께할수록 기운이 자라나요!`,
        ...
        중립: (p, o) => `${p} 기운의 펫과 ${o} 기운의 집사 — 서로의 영역을 존중하는 담백한 조화예요. 꾸준함이 힘이 됩니다.`,
    };
