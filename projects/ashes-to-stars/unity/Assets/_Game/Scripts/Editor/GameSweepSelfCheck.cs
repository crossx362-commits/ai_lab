...
namespace AshesToStars
{
    ...
    public static class GameSweepSelfCheck
    {
        ...
        internal static readonly Entry[] Registry =
        {
                ...
                new Entry { Name = "캐릭터 스크롤 크롬", Run = CharScrollHudSelfCheck.Run },
                ...
                new Entry { Name = "InvasionTowers", Run = InvasionTowersSelfCheck.Run },
                new Entry { Name = "JobCombatStat", Run = JobCombatStatSelfCheck.Run },
                ...
                new Entry { Name = "LocalNet", Run = LocalNetSelfCheck.Run },
                ...
                new Entry { Name = "NoDailyQuest", Run = NoDailyQuestSelfCheck.Run },
