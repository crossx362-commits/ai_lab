...
{
    /// <summary>
    /// 특수 직업 증표 경매 시세 하한(§18-4). 200~400 G/h의 하한 200.
    /// 옛 ListPrice는 T1 증표를 25골드로 팔아 표의 200골드보다 쌌다.
    /// QA_NO면 옛 25골드. ListPrice·TryListItem이 읽는다.
    /// </summary>
    public static class TokenPrice
    {
        ...
        public static string Line()
        {
            ...
            long n = Floor(Economy.LifeItem.SpecialJobToken);
            return $"증표 시세 하한 · {Economy.FormatCurrency(n)}(§18-4)";
        }
