...
{
    /// <summary>
    /// 필드 골드부족·마지막목숨 경고 HUD. 하단 DrawChoice 두 장이 본문 yMax=640에
    /// 붙어 내비 플레이트(636)와 4px 겹친다(실측 1280×720, 스타일·편성과 동형).
    /// QA_NO_FIELD_WARN_NAV면 그 옛 겹침. FieldScreen 경고 페이지가 읽는다.
    /// </summary>
    public static class FieldWarnHud
    {
        public const string EnvShow = "QA_FIELD_WARN";
        public const string EnvNoNav = "QA_NO_FIELD_WARN_NAV";
        public const string EnvGold = "QA_FIELD_WARN_GOLD";
