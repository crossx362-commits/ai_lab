...
## 실행
- [x] [2026-09-12 11:50] **보드 화면 개선**(오너 지시) — ①계획 진행 칩(T1 완료·T2 진행·T3~T7 대기)을 「지금」 맨 위에 ②병렬 판이 나란히 뜨도록 자동 배치 격자로 ③「이어서 할 일」·「최근 흐름」을 각자 카드로 분리(빈 여백 제거, 「최근 작업」이 두 배로 길어짐) ④파이프라인 카드에 테두리·모델 칩·시도 이력 칩 ⑤「실행·보고」는 마크다운 기호를 걷어내고 두 줄로 접어 보여주고 누르면 펼침 ⑥AI 카드에 난이도별 모델표(1급 haiku … 5급 fable). 1440·1920·500px에서 확인.
