...
최종 갱신: 2026-08-23 · 영지 §5 드래그 PASS (보드)
마지막 트랙: 코드
폴리싱 다음: **영지 HUD**.
...
1. **영지 §6 아트** — 건물·레벨 티어·공사판 아트(SPEC `GAME_SPEC_ESTATE_BUILD.md` §6). Higgsfield 또는 Grok Imagine만. 기존 장 재사용·중복 재생성 금지. 할로우 화풍 금지. §5 드래그(`6d9b4fae` SelfCheck PASS)는 닫음.
