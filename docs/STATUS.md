...
최종 갱신: 2026-08-23 · RaidReroll ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **하위 레이드 RaidScale** (재입장 `a4b9e378` 닫음).
