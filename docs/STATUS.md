...
최종 갱신: 2026-08-23 · 캐릭터 지갑 ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **캐릭터 합성 비용** (지갑 `2cabe537` 닫음).
