...
최종 갱신: 2026-08-23 · §18-9 소비처 PASS · 다음 소비처0 (보드)
마지막 트랙: 코드
폴리싱 다음: **영지 건물 칸 부제** (현황 본성·광산·창고 닫음).
