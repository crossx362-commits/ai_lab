...
최종 갱신: 2026-08-23 · 탑 대출·부채 ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **순자산·한도 NetWorth** (대출 `d7d10a95` 닫음).
