...
최종 갱신: 2026-08-23 · RaidScale ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **소프트캡 SoftCap.Line** (RaidScale `c06cf3f9` 닫음).
