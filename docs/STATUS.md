...
최종 갱신: 2026-08-23 · SoftCap.Line ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **소프트캡 HourLine** (Line `8f2a6529` 닫음).
