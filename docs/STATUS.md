...
최종 갱신: 2026-08-16 · 루프 실행기 Grok (V3 한 판 종단)

## 다음 할 일 (원장 §22 — 위에서부터 하나만)

1. **V2 사람 판정** — 실제 창에서 대시 무적 0.3초/쿨 6초. **자동검사로 통과 선언 금지.** 루프는 이 항목을 완료로 내리지 말고, 사람이 창을 열 수 없으면 원장 ✅ 갭을 찾아 다음 실행 가능 항목을 큐에 올린다.
2. **V4 삭제 루프 준비** — 보스 패배→3회 사망→삭제→계속 플레이. 영지/침략/경매/합성 새 범위는 V4 이후(§21-3).
...
최종 갱신: 2026-08-16 · 이터레이션(V3 한 판 종단 — 처치→층 돌파)
...
**루프가 끊기는 지점**: V3(보스 한 판→층 돌파)는 닫혔다. 다음 관문은 **V2 사람 판정**
(대시 무적 0.3초 — 자동검사로 완료 선언 금지)과 **V4 삭제 수용성**이다.
