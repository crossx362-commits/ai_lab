...
최종 갱신: 2026-08-23 · NetWorth ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **대보스 RaidCost** (NetWorth `faca38a5` 닫음).
