...
최종 갱신: 2026-08-23 · 약탈 상한 CapCopper ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **약탈 하한 FloorCopper** (상한 `7b098fcd` 닫음).
