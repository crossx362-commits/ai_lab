...
최종 갱신: 2026-08-23 · 본성 골드단축 ShortCopper · 소비처0 (보드)
마지막 트랙: 코드
폴리싱 다음: **광산·창고 업비** (본성 골드단축 `8cda2934` 닫음).
