...
최종 갱신: 2026-08-19 · 월드맵 침략 카드 부제
마지막 트랙: 아트
폴리싱 다음: 직전 트랙이 아트라 다음은 코드 칸. 다음 화면: 월드맵 성계·랭킹 카드 부제.
...
> **이번 이터 결과(UI/실행): 월드맵 침략 카드 부제는 한 줄.**
