...
2. **기획서 ✅ · 소비처 0곳** — 대기하지 말고 원장을 훑어 다음 구멍을 큐에 올린다. 16×16 부지·배치 프리셋·경로 전투 시뮬·무료 영입 3회·일과표는 💡라 안 연다. 동일 상대 24h -80%·인간 회복 9h는 보호막과 어긋나 안 넣음. 영공 버프는 `7dd354ea`로 다른 세션이 닫았다.
