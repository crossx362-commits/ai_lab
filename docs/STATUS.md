...
최종 갱신: 2026-08-23 · RaidCost ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **레이드 재입장 RaidReroll** (RaidCost `93e61a55` 닫음).
