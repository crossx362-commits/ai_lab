...
최종 갱신: 2026-08-23 · 탑 입장 필요·보유 ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **탑 대출·부채** (입장 `0a827a3a` 닫음).
