...
최종 갱신: 2026-08-23 · §3 쿨다운 소비처 PASS · 다음 소비처0 (보드)
마지막 트랙: 코드
폴리싱 다음: **영지 업그레이드 비용 줄** (본성 상세 `dae7471e` 닫음).
