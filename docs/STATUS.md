...
최종 갱신: 2026-08-23 · 영지 건물칸 ShortCopper · 소비처0 (보드)
마지막 트랙: 코드
폴리싱 다음: **영지 업그레이드/본성 상세** (건물칸 미리보기 `369ef98a` 닫음).
