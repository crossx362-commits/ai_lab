...
최종 갱신: 2026-08-19 · 계열 상성 ×1.3/×0.7
마지막 트랙: 코드
폴리싱 다음: 직전 트랙이 코드라 다음은 UI. 다음 칸: 화면 하나·결함 하나.
