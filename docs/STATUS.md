...
6. **단계 1 관문 측정 — 탑 30층 종단 세션**(원장 §22 「지금」 칸, 2026-08-18 추가) — 한 캐릭터로 30층까지 오르는 한 세션을 실제로 돌려 층별 소요·전투력·사망·재도전 횟수를 CSV로 남긴다. 범위는 12/14 닫혔는데 **곡선 측정은 0회**다. 원장 ✅ 소비처 루프(1번)는 범위 작업이라 이 관문을 대신하지 않는다(§22 운영 규칙 3). 수치를 먼저 고치지 말고 측정부터.
