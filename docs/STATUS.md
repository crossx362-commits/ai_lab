...
최종 갱신: 2026-08-23 · EstateBuild 골드 부족 ShortCopper (보드)
마지막 트랙: 코드
폴리싱 다음: **EstateDefense 골드 부족** (EstateBuild `2af5c766` 닫음).
