...
| 개발 직렬 | 부활초 상한 닫음 | 스타일 토글 `305bee56` · 부활초 상한 `9b50c0d7`(ReviveCap·QA_NO). `W3Party` 금지 |
...
| UI 폴리싱 다음 | 파티 출전 도크-내비 닫음 | 필드 `007f71dc`/`46b57c03` · 월드맵 `fd0ba129` · 파티 `7d9cd50b` PartyHud. 탑 HUD 겹침은 PROPOSALS |
