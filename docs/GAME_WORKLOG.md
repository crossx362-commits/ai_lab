...
| 개발 직렬 | 소환수상한 닫음 | 잡몹상한 `31836976` · 소환수상한 `bfff2789`(SummonCap·QA_NO) · 표제 `0a555592`. `W3Party` 금지 |
...
| UI 폴리싱 다음 | 영지 마을 팔레트-내비 닫음 | 필드 `007f71dc`/`46b57c03` · 월드맵 `fd0ba129` · 파티 `7d9cd50b` · 탑 `16a57558` · 현황 `0beff9ad` · 마을 `4d6f9e59` EstateHud |
